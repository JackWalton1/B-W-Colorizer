...
## <b>Colorful Image Colorization</b> [[Project Page]](http://richzhang.github.io/colorization/) <br>
 Credits to and inspired by [Richard Zhang](https://richzhang.github.io/), [Phillip Isola](http://web.mit.edu/phillipi/), [Alexei A. Efros](http://www.eecs.berkeley.edu/~efros/). In [ECCV, 2016](http://arxiv.org/pdf/1603.08511.pdf).
...
```
git clone https://github.com/JackWalton1/B-W-Colorizer.git
...
**Colorize Videos!** This script will colorize a video. The results should match the images in the `videos_out` folder.

```
python colorize_video.py -i videos/{your_video}
```
